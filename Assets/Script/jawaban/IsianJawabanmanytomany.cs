...
public class IsianJawabanmanytomany : MonoBehaviour
{
    ...
    public void OnCek()
	{
        if(field1.text.Equals("many") && field2.text.Equals("many"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
            lanjutkan.SetActive(true);
        }else  if(field1.text.Equals("Many") && field2.text.Equals("Many"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
