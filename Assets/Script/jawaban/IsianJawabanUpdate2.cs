...
public class IsianJawabanUpdate2 : MonoBehaviour
{
    ...
    public void OnCek()
	{
        if(field1.text.Equals("update barang set expired='18-04-2021' where kodeBarang='BR776';"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
            lanjutkan.SetActive(true);
        } else  if(field1.text.Equals("UPDATE barang SET expired='18-04-2021' WHERE kodeBarang='BR776';"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
