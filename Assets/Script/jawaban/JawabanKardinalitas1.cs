...
public class JawabanKardinalitas1 : MonoBehaviour
{
    ...
    public void OnCek()
	{
        if(field1.text.Equals("one") && field2.text.Equals("many"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
            lanjutkan.SetActive(true);
        }else  if(field1.text.Equals("One") && field2.text.Equals("Many"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
