...
public class JawabanDrop2 : MonoBehaviour
{
    ...
    public void OnCek()
	{
        if(field1.text.Equals("drop") && field2.text.Equals("table") && field3.text.Equals("siswa") && field4.text.Equals(";"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
            lanjutkan.SetActive(true);
        }else if(field1.text.Equals("Drop") && field2.text.Equals("Table") && field3.text.Equals("siswa") && field4.text.Equals(";"))
        {
          /*  correct.Play(0);*/
            actionBenar();
            cek.SetActive(false);
