...
public class DragSimbol : MonoBehaviour, IDragHandler, IEndDragHandler 
{

    public GameObject item1, item2, item3, item4, dragObject, target1, target2,target3,target4;
