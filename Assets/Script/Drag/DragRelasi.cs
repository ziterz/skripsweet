...
public class DragRelasi : MonoBehaviour, IDragHandler, IEndDragHandler 
{

    public GameObject item1, item2, item3, item4,item5, item6, dragObject, target1, target2, target3, benar, salah, lanjutkan;
