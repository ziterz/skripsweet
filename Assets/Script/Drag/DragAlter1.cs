...
public class DragAlter1 : MonoBehaviour, IDragHandler, IEndDragHandler 
{

    public GameObject item1, item2, item3, item4,item5, dragObject, target1, target2, target3,target4,target5;
