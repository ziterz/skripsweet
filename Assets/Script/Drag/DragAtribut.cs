...
public class DragAtribut : MonoBehaviour, IDragHandler, IEndDragHandler 
{

    public GameObject item1, item2, item3, item4,item5, item6,item7, dragObject, target1, target2, target3;
    Vector3 startpos, startpos1, startpos2, startpos3, startpos4, startpos5, startpos6, startpos7;
    ...
    public void OnEndDrag(PointerEventData eventData)
	{
		...
		if(Dis1<2)
        {
            if (item1.transform.position == target1.transform.position) {
                ...
                item6Back();
            }else if (item7.transform.position == target1.transform.position) {
                item7Back();
            }
        ...
        else if(Dis2<2)
        {
            if (item1.transform.position == target2.transform.position) {
                ...
                item6Back();
            }else if (item7.transform.position == target2.transform.position) {
                item7Back();
            }
        ...
        else if(Dis3<2)
        {
            if (item1.transform.position == target3.transform.position) {
                ...
                item6Back();
            }else if (item7.transform.position == target3.transform.position) {
                item7Back();
            }
    ...
    void item7Back()
	{
		item7.transform.position = startpos7;
	}
